...
public class CameraControlTrigger : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider collision)
    {
        if (collision.CompareTag("Player"))
        {
            ...
            {
                //pan the camera based on pan direction in the inspector
...
public class MyScriptEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (cameraControlTrigger.customInspectorObjects.panCameraOnContact)
        {
            ...
            cameraControlTrigger.customInspectorObjects.panDistance = EditorGUILayout.FloatField("Camera Pan Distance", cameraControlTrigger.customInspectorObjects.panDistance);
            cameraControlTrigger.customInspectorObjects.panTime = EditorGUILayout.FloatField("Camera Pan Time", cameraControlTrigger.customInspectorObjects.panTime);
        }
